...
$(document).ready(function() {
  ...
  var navigating = false,
      ...
      $textStuff = $(".section-heading, .additional-text, .more-text, .link-heading");
  ...
  */
  function timeoutNav(t) {
    ...
    setTimeout(function() {
      ...
      $(".section-heading, .additional-text, .more-text, .link-heading").css({"margin-top": 0 - (parseInt($(".nav-elem.active").attr("data-page")) - 1) * 100 + "vh"}).hide();
    }, 410);
    setTimeout(function() {
      $textStuff.show();
      $textStuff.css("top");
